...
@RestController
@RequestMapping("/api/declaration-kafka")
public class DeclarationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DeclarationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DeclarationKafkaResource(KafkaProperties kafkaProperties) {
